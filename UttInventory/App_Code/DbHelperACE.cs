...
namespace UttInventory
{
    public class DbHelperACE
    {
        ...
        public static string connectionString =
            System.Configuration.ConfigurationSettings.AppSettings["con"].Trim() +
            System.Web.HttpContext.Current.Server.MapPath("~/App_Data/") + "\\" +
            System.Configuration.ConfigurationSettings.AppSettings["dbname"].Trim();
